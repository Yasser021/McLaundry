        ...
        <div class="card-body">
            ...
            <form action="{{ url('member/'.$data->id_member) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="id_member" id="id" class="form-control" placeholder="Isi ID Member" value="{{ $data->id_member }}">
                </div>
                <div class="mb-3">
                    <label for="nm" class="mb-2">Nama member</label>
                    <input type="text" name="nm_member" id="nm" class="form-control"
                        placeholder="Isi Nama Member" value="{{ $data->nm_member }}">
                </div>
                <div class="mb-3">
                    <label for="alamat" class="mb-2">Alamat</label>
                    <input type="text" name="alamat_member" id="alamat" class="form-control"
                        placeholder="Isi Alamat Member" value="{{ $data->alamat_member }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="no_member" id="no" class="form-control"
                        placeholder="Isi Nomor Telepon Member" value="{{ $data->no_member }}">
                </div>
                <div class="">
